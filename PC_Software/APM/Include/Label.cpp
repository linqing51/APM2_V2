...
BEGIN_MESSAGE_MAP(CLabel, CBCGPStatic)
	//{{AFX_MSG_MAP(CLabel)
	ON_WM_TIMER()
	ON_WM_LBUTTONDOWN()
	ON_WM_SETCURSOR()
...
BOOL CLabel::OnSetCursor(CWnd* pWnd, UINT nHitTest, UINT message) 
{
	...
	return CBCGPStatic::OnSetCursor(pWnd, nHitTest, message);
}
...
void CLabel::OnLButtonDown(UINT nFlags, CPoint point) 
{
	...
	if (!m_bNotifyParent) // Fix
	{
		...
		if (m_Link == MailLink)
		{
			strLink = CString("mailto:") + strLink;
...
//////////////////////////////////////////////////////////////////////////
CLabel& CLabel::SetText(const CString& strText, BOOL bRepaint)
{
...
//
//////////////////////////////////////////////////////////////////////////
CLabel& CLabel::SetTextColor(COLORREF crText, BOOL bRepaint)
{
...
//
//////////////////////////////////////////////////////////////////////////
CLabel& CLabel::SetFontBold(BOOL bBold, BOOL bRepaint)
{	
...
//
//////////////////////////////////////////////////////////////////////////
CLabel& CLabel::SetFontUnderline(BOOL bSet, BOOL bRepaint)
{	
...
//
//////////////////////////////////////////////////////////////////////////
CLabel& CLabel::SetFontItalic(BOOL bSet,  BOOL bRepaint )
{
...
//
//////////////////////////////////////////////////////////////////////////
CLabel& CLabel::SetFontSize(int nSize, BOOL bRepaint)
{
...
//
//////////////////////////////////////////////////////////////////////////
CLabel& CLabel::SetBkColor(COLORREF crBkgnd, COLORREF crBkgndHigh, BackFillMode mode, BOOL bRepaint)
{
...
//////////////////////////////////////////////////////////////////////////
CLabel& CLabel::SetFontName(const CString& strFont, BYTE byCharSet /* Default = ANSI_CHARSET */, BOOL bRepaint)
{	
...
//
//////////////////////////////////////////////////////////////////////////
CLabel& CLabel::SetTransparent(BOOL bSet, BOOL bRepaint)
{
...
//
//////////////////////////////////////////////////////////////////////////
CLabel& CLabel::SetFont3D(BOOL bSet, Type3D type, BOOL bRepaint)
{
...
//
//////////////////////////////////////////////////////////////////////////
CLabel& CLabel::SetRotationAngle(UINT nAngle, BOOL bRotation, BOOL bRepaint)
{
	// Arrrrh...
...
//
//////////////////////////////////////////////////////////////////////////
CLabel& CLabel::SetText3DHiliteColor(COLORREF cr3DHiliteColor, BOOL bRepaint)
{
...
{	
	return CBCGPStatic::PreCreateWindow(cs);
}
...
//////////////////////////////////////////////////////////////////////////
CLabel& CLabel::SetFont(LOGFONT lf, BOOL bRepaint)
{
